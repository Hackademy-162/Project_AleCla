    ...
    <div class="container-fluid vh-100 imgCont">
        <div class="row">
            <div class="col-12 mt-5 text-white">
                ...
                <br>
                Alleviamo belve pericolose, assumiamo pernsonale squalificato e contribuiamo al degrado turistico con ogni fibra el nostro corpo, per assicurarci che se anche facessi un viaggio soltanto con noi, esso sia "il tuo ultimo viaggio".
                <br>
